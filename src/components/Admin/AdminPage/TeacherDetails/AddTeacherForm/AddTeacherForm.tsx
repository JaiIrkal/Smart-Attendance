import { Box, MenuItem, Stack, TextField, Button, Typography, Divider, CircularProgress } from "@mui/material";
    ...
    return (
        ...
        formSubmitted ?
            <Box alignItems={'center'} justifyContent='center'>
                <Typography>Teacher Added!!</Typography>
                    ...
                    <form onSubmit={formik.handleSubmit} onReset={formik.handleReset}>
                        <Stack gap='15px'>
                            ...
                            <Stack direction={'row'} gap='40px' justifyContent={'center'} >
                                ...
                                <Button
                                    startIcon={
                                        formSubmitted ? <CircularProgress size="1rem" /> : null
                                    }
                                    type='submit'
